...
namespace Northwind.Core.UnitTests.Services
{
    public class CustomersServiceTests
    {
        ...
        public async Task Edit_ShouldThrowExceptionIfArgumentIsNull()
        {
            ...
            await Assert.ThrowsAsync<ArgumentNullException>(() => service.Update("AAAA", null!));
        }
        ...
        public async Task Edit_ShouldThrowValidationFailedException()
        {
            ...
            await Assert.ThrowsAsync<ValidationFailedException>(() => service.Update("AAAA", new CustomerDto()));
        }
        ...
        public async Task Edit_ShouldThrowDataNotFoundExceptionIfCustomerIsNotFound()
        {
            ...
            customersRepository.Setup(x => x.Get(It.IsAny<string>())).ReturnsAsync((Customer?)null);
