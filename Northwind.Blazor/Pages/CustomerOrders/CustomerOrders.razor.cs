...
namespace Northwind.Blazor.Pages.CustomerOrders
{
    public partial class CustomerOrders
    {
        ...
        private async Task LoadOrdersAsync()
        {
            ...
            var result = orders.Records.Select(x => new CustomerOrder { Id = x.Id, Customer = new Core.Dtos.CustomerDto { Id = x.CustomerId, Name = x.CustomerName }, Status = x.Status, Total = x.Total }).ToList();
